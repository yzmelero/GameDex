...
/**
 * Objecte que proporciona una instància de Retrofit configurada per a les operacions de la API REST de biblioteques de videojocs.
 */
object RetrofitInstance {
    ...
    /**
     * Instància de l'API de biblioteques creada per Retrofit.
     */
