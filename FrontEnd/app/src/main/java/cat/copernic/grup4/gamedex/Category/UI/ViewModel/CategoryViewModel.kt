...
class CategoryViewModel(private val categoryCasesAdd: CategoryCasesAdd,
                        private val categoryCasesGetAll: CategoryCasesGetAll) : ViewModel() {
    ...
    fun getAllCategory() {
        viewModelScope.launch {
            val response = categoryCasesGetAll.getAllCategory()
